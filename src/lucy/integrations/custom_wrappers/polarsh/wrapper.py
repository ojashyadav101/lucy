...
async def _make_request(
    ...
    try:
        async with httpx.AsyncClient(
            follow_redirects=True, timeout=settings.polar_api_timeout_s
        ) as client:
...
TOOLS = [
    {
        ...
        "description": "List products available on Polar.sh. Supports filtering by ID, organization ID, query, archived status, and recurring status. Use `page` and `limit` for pagination.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "organization_id": {
                    "type": "string",
                    "description": "ID of the organization that owns the product.",
                    "min_length": 1,
                },
                "type": {
                    "type": "string",
                    "description": "Type of the product (e.g., 'product', 'subscription').",
                ...
                "prices": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "recurring_interval": {
                                "type": "string",
                                "description": "Interval for recurring prices (e.g., 'month', 'year').",  # noqa: E501
                            },
                            "recurring_interval_count": {
                                "type": "integer",
                                "description": "Number of intervals for recurring prices.",
                            },
                        },
    ...
    },
    {
        ...
        "description": "List subscriptions. Supports filtering by organization ID, product ID, customer ID, external customer ID, and discount ID. Use `page` and `limit` for pagination.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                ...
                "external_customer_id": {
                    "type": "string",
                    "description": "External Customer ID to filter by.",
                },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "starts_at": {
                    "type": "string",
                    "format": "date-time",
                    "description": "Timestamp when the subscription starts.",
                },
                "cancel_at_period_end": {
                    "type": "boolean",
                    "description": "Whether to cancel the subscription at the end of the current period.",  # noqa: E501
                },
            },
    ...
    },
    {
        ...
        "description": "List Polar.sh customers. For Excel reports: pass export_excel=true to generate a formatted Excel file with ALL customers. Returns a file path you can upload to Slack. For quick lookups: use default pagination.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                ...
                "query": {
                    "type": "string",
                    "description": "Search query for customer names or emails.",
                },
                "page": {
                    "type": "integer",
                    "description": "Page number for pagination.",
                ...
                "export_excel": {
                    "type": "string",
                    "description": "Set to 'true' to generate a formatted Excel file with ALL customers.",  # noqa: E501
                    "default": "false",
                },
                "return_all": {
                    "type": "string",
                    "description": "Set to 'true' to return ALL customers as JSON.",
                    "default": "false",
                },
            },
        },
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "external_id": {
                    "type": "string",
                    "description": "An optional external ID for the customer.",
                },
            },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "email": {
                    "type": "string",
                    "format": "email",
                    "description": "New email address of the customer.",
                },
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "anonymize": {
                    "type": "boolean",
                    "description": "Whether to anonymize the customer data instead of full deletion.",  # noqa: E501
                    "default": False,
                },
            },
            "required": ["id"],
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "product_id": {
                    "type": "string",
                    "description": "ID of the product for the checkout link.",
                    "min_length": 1,
                },
                "price_id": {
                    "type": "string",
                    "description": "ID of the price to use for the checkout.",
                    "min_length": 1,
                },
                "success_url": {
                    "type": "string",
                ...
                "customer_id": {
                    "type": "string",
                    "description": "Optional customer ID to pre-fill checkout.",
                },
            },
    ...
    },
    {
        ...
        "description": "List Polar.sh orders. For Excel reports: pass export_excel=true to generate a formatted Excel file with ALL orders. Returns a file path you can upload to Slack.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                ...
                "product_billing_type": {
                    "type": "string",
                    "description": "Billing type of the product (e.g., 'one_time', 'recurring').",
                },
                "discount_id": {"type": "string", "description": "Discount ID to filter by."},
                "customer_id": {"type": "string", "description": "Customer ID to filter by."},
                "page": {
                ...
                "export_excel": {
                    "type": "string",
                    "description": "Set to 'true' to generate a formatted Excel file with ALL orders.",  # noqa: E501
                    "default": "false",
                },
                "return_all": {
                    "type": "string",
                    "description": "Set to 'true' to return ALL orders as JSON.",
                    "default": "false",
                },
            },
        },
    ...
    },
    {
        ...
        "description": "List webhook endpoints for an organization. Use `page` and `limit` for pagination.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "enabled_events": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "List of event types to send to this endpoint (e.g., 'order.created', 'subscription.updated').",  # noqa: E501
                },
            },
    ...
    },
    {
        ...
        "description": "List benefit grants. Supports filtering by organization ID, customer ID, external customer ID, and granted status. Use `page` for pagination.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                ...
                "is_granted": {
                    "type": "boolean",
                    "description": "Filter by whether the benefit is granted.",
                },
                "page": {
                    "type": "integer",
                    "description": "Page number for pagination.",
    ...
    },
    {
        ...
        "description": "List benefits. Supports filtering by organization ID, type, ID, excluding ID, and query. Use `page` and `limit` for pagination.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                ...
                "exclude_id": {
                    "type": "string",
                    "description": "Benefit ID to exclude from results.",
                },
                "query": {
                    "type": "string",
                    "description": "Search query for benefit names or descriptions.",
                },
                "page": {
                    "type": "integer",
                    "description": "Page number for pagination.",
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "type": {
                    "type": "string",
                    "description": "Type of the benefit (e.g., 'ads', 'discord').",
                    "min_length": 1,
                },
                "description": {
                    "type": "string",
                ...
                "is_tax_applicable": {
                    "type": "boolean",
                    "description": "Whether the benefit is tax applicable.",
                },
                "selectable": {
                    "type": "boolean",
                    "description": "Whether the benefit is selectable by customers.",
                },
                "properties": {
                    "type": "object",
                    "description": "Additional properties for the benefit, depends on type.",
                },
            },
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "id": {
                    "type": "string",
                    "description": "The ID of the benefit to retrieve.",
                    "min_length": 1,
                }
            },
            "required": ["id"],
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "properties": {
                    "type": "object",
                    "description": "New additional properties for the benefit.",
                },
            },
            "required": ["id"],
        },
    ...
    },
    {
        ...
        "description": "List discounts. Supports filtering by organization ID and query. Use `page`, `limit`, and `sorting` for pagination and ordering.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                ...
                "query": {
                    "type": "string",
                    "description": "Search query for discount codes or names.",
                },
                "page": {
                    "type": "integer",
                    "description": "Page number for pagination.",
                ...
                "sorting": {
                    "type": "string",
                    "description": "Sorting order (e.g., 'created_at', '-created_at').",
                },
            },
        },
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "type": {
                    "type": "string",
                    "description": "Type of discount (e.g., 'fixed_amount', 'percentage').",
                    "enum": ["fixed_amount", "percentage"],
                    "min_length": 1,
                },
                "value": {
                    "type": "integer",
                    "description": "The discount value (e.g., amount in cents for fixed, percentage for percentage).",  # noqa: E501
                    "minimum": 0,
                },
                "product_id": {
                    "type": "string",
                    "description": "Optional product ID to apply the discount to.",
                },
                "starts_at": {
                    "type": "string",
                    "format": "date-time",
    ...
    },
    {
        ...
        "action_type": "READ",
        "description": "Retrieve metrics for an organization within a specified date range and interval.",  # noqa: E501
        "parameters": {
            "type": "object",
            "properties": {
                "organization_id": {
                    "type": "string",
                    "description": "ID of the organization to retrieve metrics for.",
                    "min_length": 1,
                },
                "start_date": {
                    "type": "string",
                    "format": "date",
                    "description": "Start date for the metrics (YYYY-MM-DD).",
                    "min_length": 1,
                },
                "end_date": {
                    "type": "string",
                    "format": "date",
                    "description": "End date for the metrics (YYYY-MM-DD).",
                    "min_length": 1,
                },
                "interval": {
                    "type": "string",
                    "description": "Interval for the metrics (e.g., 'day', 'week', 'month').",
                    "enum": ["day", "week", "month"],
                    "min_length": 1,
                },
                "timezone": {
                    "type": "string",
                    "description": "Timezone for the metrics (e.g., 'UTC', 'America/New_York').",
                    "default": "UTC",
                },
            },
...
async def execute(tool_name: str, args: dict, api_key: str) -> dict:
    if tool_name == "polarsh_list_products":
        return await _make_request("GET", f"{API_BASE_URL}/v1/products/", api_key, params=args)
    elif tool_name == "polarsh_create_product":
        return await _make_request("POST", f"{API_BASE_URL}/v1/products/", api_key, json_data=args)
    elif tool_name == "polarsh_get_product":
        product_id = args.pop("id")
        return await _make_request("GET", f"{API_BASE_URL}/v1/products/{product_id}", api_key)
        ...
        return await _make_request("GET", f"{API_BASE_URL}/v1/subscriptions/", api_key, params=args)
        ...
        if export_excel or return_all:
            ...
            if export_excel:
                ...
                return {
                    ...
                    "note": f"Excel created with ALL {len(all_customers)} customers. Upload it to Slack.",  # noqa: E501
                }
            return {"total_count": len(all_customers), "items": all_customers}
        return await _make_request("GET", f"{API_BASE_URL}/v1/customers/", api_key, params=args)
    elif tool_name == "polarsh_create_customer":
        return await _make_request("POST", f"{API_BASE_URL}/v1/customers/", api_key, json_data=args)
    elif tool_name == "polarsh_get_customer":
        customer_id = args.pop("id")
        return await _make_request("GET", f"{API_BASE_URL}/v1/customers/{customer_id}", api_key)
        ...
        return await _make_request("GET", f"{API_BASE_URL}/v1/orders/", api_key, params=args)
    elif tool_name == "polarsh_get_order":
        order_id = args.pop("id")
        return await _make_request("GET", f"{API_BASE_URL}/v1/orders/{order_id}", api_key)
    elif tool_name == "polarsh_generate_order_invoice":
        order_id = args.pop("id")
        return await _make_request("POST", f"{API_BASE_URL}/v1/orders/{order_id}/invoice", api_key)
        ...
        return await _make_request("GET", f"{API_BASE_URL}/v1/benefits/", api_key, params=args)
    elif tool_name == "polarsh_create_benefit":
        return await _make_request("POST", f"{API_BASE_URL}/v1/benefits/", api_key, json_data=args)
    elif tool_name == "polarsh_get_benefit":
        benefit_id = args.pop("id")
        return await _make_request("GET", f"{API_BASE_URL}/v1/benefits/{benefit_id}", api_key)
        ...
        benefit_id = args.pop("id")
        return await _make_request("DELETE", f"{API_BASE_URL}/v1/benefits/{benefit_id}", api_key)
    elif tool_name == "polarsh_list_discounts":
        return await _make_request("GET", f"{API_BASE_URL}/v1/discounts/", api_key, params=args)
    elif tool_name == "polarsh_create_discount":
        return await _make_request("POST", f"{API_BASE_URL}/v1/discounts/", api_key, json_data=args)
    elif tool_name == "polarsh_get_discount":
        discount_id = args.pop("id")
        return await _make_request("GET", f"{API_BASE_URL}/v1/discounts/{discount_id}", api_key)
        ...
        discount_id = args.pop("id")
        return await _make_request("DELETE", f"{API_BASE_URL}/v1/discounts/{discount_id}", api_key)
    elif tool_name == "polarsh_get_metrics":
        return await _make_request("GET", f"{API_BASE_URL}/v1/metrics/", api_key, params=args)
    else:
