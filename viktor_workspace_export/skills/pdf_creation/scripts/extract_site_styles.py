...
Run with:
    uv run python skills/pdf_creation/scripts/extract_site_styles.py https://example.com/
...
def main():
    if len(sys.argv) < 2:
        print("Usage: uv run python skills/pdf_creation/scripts/extract_site_styles.py <url>")
        print(
            "Example: uv run python skills/pdf_creation/scripts/extract_site_styles.py https://example.com/"
        )
        sys.exit(1)
