...
**Em dashes:** Avoid em dashes (—) in prose, they're the #1 AI writing tell. Use commas, periods, or semicolons instead. Exception: em dashes work as structural separators in list items (e.g., "📧 Gmail — emails, contacts") for clean visual hierarchy.
